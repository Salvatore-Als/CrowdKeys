...
public sealed class Loc : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ["fr"] = new()
        {
            ...
            ["Step_TypeSound"]    = "SON",
            ["Step_TypeImage"]    = "IMAGE",
            ["Step_AddSound"]     = "Son",
            ["Step_AddImage"]     = "Image",
            ["Step_SoundFile"]    = "FICHIER SON",
            ["Step_SoundVolume"]  = "VOLUME (%)",
            ["Step_ImageFile"]    = "FICHIER IMAGE",
            ["Step_ImagePosition"] = "POSITION",
            ["Step_ImageDelay"]   = "DÉLAI D'AFFICHAGE (MS)",
            ["Step_Browse"]       = "Parcourir…",
            ["Step_NoFileSelected"] = "Aucun fichier sélectionné",
            ["Position_TopLeft"]      = "Haut Gauche",
            ["Position_TopCenter"]    = "Haut Milieu",
            ["Position_TopRight"]     = "Haut Droite",
            ["Position_MiddleLeft"]   = "Milieu Gauche",
            ["Position_Center"]       = "Centre",
            ["Position_MiddleRight"]  = "Milieu Droite",
            ["Position_BottomLeft"]   = "Bas Gauche",
            ["Position_BottomCenter"] = "Bas Milieu",
            ["Position_BottomRight"]  = "Bas Droite",
        ...
        ["en"] = new()
        {
            ...
            ["Step_TypeSound"]    = "SOUND",
            ["Step_TypeImage"]    = "IMAGE",
            ["Step_AddSound"]     = "Sound",
            ["Step_AddImage"]     = "Image",
            ["Step_SoundFile"]    = "SOUND FILE",
            ["Step_SoundVolume"]  = "VOLUME (%)",
            ["Step_ImageFile"]    = "IMAGE FILE",
            ["Step_ImagePosition"] = "POSITION",
            ["Step_ImageDelay"]   = "DISPLAY DELAY (MS)",
            ["Step_Browse"]       = "Browse…",
            ["Step_NoFileSelected"] = "No file selected",
            ["Position_TopLeft"]      = "Top Left",
            ["Position_TopCenter"]    = "Top Center",
            ["Position_TopRight"]     = "Top Right",
            ["Position_MiddleLeft"]   = "Middle Left",
            ["Position_Center"]       = "Center",
            ["Position_MiddleRight"]  = "Middle Right",
            ["Position_BottomLeft"]   = "Bottom Left",
            ["Position_BottomCenter"] = "Bottom Center",
        ...
        ["de"] = new()
        {
            ...
            ["Step_AddSound"]     = "Sound",
            ["Step_AddImage"]     = "Bild",
            ["Step_SoundFile"]    = "SOUNDDATEI",
            ["Step_SoundVolume"]  = "LAUTSTÄRKE (%)",
            ["Step_ImageFile"]    = "BILDDATEI",
            ["Step_ImagePosition"] = "POSITION",
            ["Step_ImageDelay"]   = "ANZEIGEDAUER (MS)",
            ["Step_Browse"]       = "Durchsuchen…",
            ["Step_NoFileSelected"] = "Keine Datei ausgewählt",
            ["Position_TopLeft"]      = "Oben Links",
            ["Position_TopCenter"]    = "Oben Mitte",
            ["Position_TopRight"]     = "Oben Rechts",
            ["Position_MiddleLeft"]   = "Mitte Links",
            ["Position_Center"]       = "Mitte",
            ["Position_MiddleRight"]  = "Mitte Rechts",
            ["Position_BottomLeft"]   = "Unten Links",
            ["Position_BottomCenter"] = "Unten Mitte",
        ...
        ["it"] = new()
        {
            ...
            ["Step_TypeSound"]    = "SUONO",
            ["Step_TypeImage"]    = "IMMAGINE",
            ["Step_AddSound"]     = "Suono",
            ["Step_AddImage"]     = "Immagine",
            ["Step_SoundFile"]    = "FILE AUDIO",
            ["Step_SoundVolume"]  = "VOLUME (%)",
            ["Step_ImageFile"]    = "FILE IMMAGINE",
            ["Step_ImagePosition"] = "POSIZIONE",
            ["Step_ImageDelay"]   = "DURATA VISUALIZZAZIONE (MS)",
            ["Step_Browse"]       = "Sfoglia…",
            ["Step_NoFileSelected"] = "Nessun file selezionato",
            ["Position_TopLeft"]      = "Alto Sinistra",
            ["Position_TopCenter"]    = "Alto Centro",
            ["Position_TopRight"]     = "Alto Destra",
            ["Position_MiddleLeft"]   = "Centro Sinistra",
            ["Position_Center"]       = "Centro",
            ["Position_MiddleRight"]  = "Centro Destra",
            ["Position_BottomLeft"]   = "Basso Sinistra",
            ["Position_BottomCenter"] = "Basso Centro",
            ["Position_BottomRight"]  = "Basso Destra",
